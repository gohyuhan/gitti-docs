---
sidebar_position: 5
description: 在 Gitti 中使用专用提交 UI 编写、修改和签名提交，支持 GPG/SSH 提交签名，并提供可视化的提交日志和分支图。
keywords:
  - git 提交 tui
  - 修改提交
  - 提交签名 gpg ssh
...
修改提交历史中的单个提交。详情请参阅 [交互式变基](./interactive-rebase.md)。

1.  **导航**: 按 `3` 聚焦 **提交日志** 面板。
2.  **触发**: 按 `i` 打开操作选择器。
3.  **选择操作**: 选择 Drop、Reword 或 Fixup/Squash。
