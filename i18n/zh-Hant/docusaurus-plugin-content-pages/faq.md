...
有關目前的安裝說明，請參閱 [安裝](/docs/installation) 頁面。

## 如何安裝 Gitti？

請轉到 [安裝](/docs/installation) 指南以獲取最新的命令。簡而言之，您通常可以透過以下方式安裝 Gitti：
...
檢視 [鍵綁定](/docs/keybindings) 頁面以獲取完整列表。許多按鍵都受到流行終端工具的啟發，因此很容易記住。
