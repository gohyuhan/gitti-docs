---
sidebar_position: 5
description: 在 Gitti 中使用專用提交 UI 編寫、修改和簽名提交，支援 GPG/SSH 提交簽名，並提供可視化的提交日誌和分支圖。
keywords:
  - git 提交 tui
  - 修改提交
  - 提交簽名 gpg ssh
...
修改提交歷史中的單個提交。詳情請參閱 [互動式變基](./interactive-rebase.md)。

1.  **導航**: 按 `3` 聚焦 **提交日誌** 面板。
2.  **觸發**: 按 `i` 打開操作選擇器。
3.  **選擇操作**: 選擇 Drop、Reword 或 Fixup/Squash。
