---
sidebar_position: 1
description: Manage Git branches in Gitti — view, create, switch, delete, rebase onto another branch and merge with configurable fast-forward, all from the terminal.
keywords:
