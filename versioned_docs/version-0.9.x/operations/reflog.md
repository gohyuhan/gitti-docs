---
sidebar_position: 8
description: Browse the Git reflog in Gitti to recover lost commits and branches — create branches, reset and cherry-pick from any historical reference entry.
keywords:
  - git reflog
