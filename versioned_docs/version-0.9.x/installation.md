---
sidebar_position: 2
description: Install Gitti on macOS, Linux and Windows via curl, Homebrew, Scoop or go install. Quick setup for the fast, lightweight Git terminal UI.
keywords:
  - install gitti
  - gitti install
  - homebrew gitti
