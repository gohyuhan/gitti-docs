...
### Individual Line Staging

For precise control, you can stage or unstage specific lines within a file.
...
3.  **Toggle**: Press `space` to stage or unstage the currently selected line.
4.  **Exit**: Press `L` again or `esc` to exit line staging mode.
